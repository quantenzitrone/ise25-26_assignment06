    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            ...
                            description = "No Usr with the provided ID could be found."
                    )
            }
    )
    @GetMapping("/{id}")
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            ...
                            description = "Validation failed (e.g., invalid e-mail address, login name, first name, last name or bean validation errors)."
                    )
            }
    )
    @PostMapping("")
